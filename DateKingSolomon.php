...
<head>
    ...
    <title>KingSolomon Hotel</title>    
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    <link rel="stylesheet" a href="../CSS/KingSolomonHotel.css">
...
<body>
  ...
  <h3 style="text-align: center; color: goldenrod;">for more info please call: 08-636-3444 </h3>
        <nav role="navigation">
          ...
          <a href="../HTML/KingSolomonHotel.html"><input class="btn solid" type="submit" value="Go Back"/></a>
